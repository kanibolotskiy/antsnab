...
class Hierarhy extends \Model
{
    ...
    {
        /** 
         *  Дерево хранится сериализованно в файловом кэше. Чтобы не тратить ресурсы на 
         *  десериализацию во время исполнения - для повторных обращений сохраняем в сессионный
         *  кэш дополнительно
         */ 
