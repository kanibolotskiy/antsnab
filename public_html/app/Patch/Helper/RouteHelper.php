...
class RouteHelper
{
    ...
    const DIR_APP = 'app/';
    const DIR_CONTROLLER_OVERRIDE = 'app/Override/Controller/';
    const DIR_SERVICE = 'app/Service/';
    const DIR_VIEW_DECORATORS = 'app/Overrdie/Controller/';
    ...
    const CONTROLLER_NAMESPACE = 'WS\\Override\\Controller\\';
    const VIEW_NAMESPACE = 'WS\\Override\\Controller\\';
