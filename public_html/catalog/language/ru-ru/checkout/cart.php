...
$_['text_empty']               = '<p>В корзине пока пусто.<br><br>Мы уверены, что в <a href="/products/">каталоге продукции</a> Вы найдете для себя что-то интересное.</p>'; 
$_['empty_cart']               = '<p>В корзине пока пусто.<br><br>Мы уверены, что в <a href="/products/">каталоге продукции</a> Вы найдете для себя что-то интересное.</p>'; 
...
$_['error_name'] = 'Необходимо заполнить';
$_['error_phone'] = 'Необходимо заполнить';
$_['error_phone2'] = 'Неверный формат';
$_['error_email'] = 'Неверный формат';
$_['error_shipping_address'] = 'Введите адрес доставки';
