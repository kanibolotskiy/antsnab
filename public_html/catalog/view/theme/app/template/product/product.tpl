                                ...
                                <div class="description-price">
                                    ...
                                    <?php if(!$notavail){ ?>
                                        ...
                                        <span itemprop="priceSpecification" itemscope  itemtype="http://schema.org/PriceSpecification">
                                            <meta itemprop="priceCurrency" content="RUB"/>
                                            <meta itemprop="minPrice" content="<?php echo round($price_wholesale,2);?>">                                        
                                            <meta itemprop="maxPrice" content="<?php echo round($price,2);?>">
                                    ...
                                    <div class="wholesale">
                                        ...
                                        <div class="wholesale-price">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <span id="priceWholesaleDescr"></span>
                                        ...
                                        <?php }else{ ?>
                                            <p>в данный момент цена неизвестна</p>
                                        <?php } ?>
                                    </div> 
                                    <!-- // -->
                                    ...
                                    <div class="state_stock">
                                        ...
                                        <div class="state_stock_col">
                                            <div class="state_stock_col_info  _delivery">
                                                ...
                                                <?php }else{ ?>
                                                    <div class="state_stock_val js_modal with_goal" data-goal="delivery" data-modal="modal_delivery_cost">Под заказ</div>
                                                <?php }?>
                                            </div>
                                        </div>
                                    </div>
...
<picture >
    ...
    <img src="<?=$p['thumb']?>" alt="<?=$p['name']?>" title="<?=$p['name']?>">
                                            ...
                                            <div class="pr_price_block"><?=$p['price']?> <span>₽</span></div>
    ...
    <img src="<?=$p['thumb']?>" alt="<?=$p['name']?>" title="<?=$p['name']?>">
            ...
            <?php }else{ ?>
                <?php if($products_analog){ ?>
                    ...
                    <div class="tab-block tab-block2 tab-block3 notavail_analogs">
