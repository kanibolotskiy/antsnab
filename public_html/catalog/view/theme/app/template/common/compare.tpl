    ...
    <div class="container main _compare">
        ...
        <div class="content without_sidebar">
                    ...
                    <div class="compare_catalog_block" rel="<?=$favorite_product['catalog_id']?>" style="<?php echo ($z==0?'display:block;':''); ?>">
                        <div class="left_compare">
                            <div class="compare_header compare_header_ico">
                                ...
                                <div class="left_compare_checkbox checkbox">
                                    <input class="check_compare" type="checkbox" id="check_compare_<?=$favorite_product['catalog_id'];?>"/>
                            ...
                            <div class="compare_body">
                                ...
                                <div class="compare_blocks" rel="compare_avail">
                                    <div class="compare_block comp_row" rel="comp_row_avail_0">Наличие</div>
                                    <div class="compare_block comp_row" rel="comp_row_avail_1">Доставка</div>
                                </div>
            ...
            <div class="permanent_link_button" href="compare/" id="permanent_link_button" data-title="Скопировано">
                <span>Постоянная ссылка на список сравнения</span>
            </div>
<!--
            <div class="permanent_link" href="compare/" id="permanent_link">
                Постоянная <a href="<?php echo 'compare/?comp_items='.$comp_items;?>">ссылка</a> на список сравнения
            </div>
-->
        </div>
