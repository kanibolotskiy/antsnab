...
<!--[if (gte IE 9) | !(IE)]><!--><html lang="en" class="no-js"><!--<![endif]-->
    <head>
        ...
        <link rel="preload" as="style" href="/catalog/view/theme/app/bundle/app2.css?v2.95" >
        <link rel="preload" as="script" href="catalog/view/theme/app/bundle/app2.js?v2.95" >
        <link rel="stylesheet" href="/catalog/view/theme/app/bundle/app2.css?v2.95">
