<?php class ControllerExtensionFeedTurboRSS extends Controller {
	...
	public function index() {
		if ($this->config->get('turbo_rss_status')) {
			...
			if ($show_image) {
				$image_width = $this->config->get('turbo_rss_image_width') ? $this->config->get('turbo_rss_image_width') : 300;
				$image_height = $this->config->get('turbo_rss_image_height') ? $this->config->get('turbo_rss_image_height') : 300;
			}
