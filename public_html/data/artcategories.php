...
define('SRC_ROOT_LEVEL_ID', 222);
define('SRC_CATEGORY_DOCUMENT_TYPE', 221);
...
define('DST_DEFAULT_ROOT_CATEGORY', 2);
...
$dataConst = [
    ...
    'template_category' => 'allarticles.tpl',
...
foreach ($rows as $row) {
    ...
    echo "\n migrated " . $counter . " article categories ";
