...
class ControllerExtensionFeedYandexMarket extends Controller {
	...
	public function index() {
		...
		$data['entry_deliverycost'] = $this->language->get('entry_deliverycost');
		$data['entry_deliverydate'] = $this->language->get('entry_deliverydate');
		$data['entry_deliverypre'] = $this->language->get('entry_deliverypre');
		...
		//Добавлена доставка
		if (isset($this->request->post['yandex_market_deliverycost'])) {
			$data['yandex_market_deliverycost'] = $this->request->post['yandex_market_deliverycost'];
		} else {
			$data['yandex_market_deliverycost'] = $this->config->get('yandex_market_deliverycost');
		}
		if (isset($this->request->post['yandex_market_deliverydate'])) {
			$data['yandex_market_deliverydate'] = $this->request->post['yandex_market_deliverydate'];
		} else {
			$data['yandex_market_deliverydate'] = $this->config->get('yandex_market_deliverydate');
		}
		if (isset($this->request->post['yandex_market_deliverypre'])) {
			$data['yandex_market_deliverypre'] = $this->request->post['yandex_market_deliverypre'];
		} else {
			$data['yandex_market_deliverypre'] = $this->config->get('yandex_market_deliverypre');
		}
