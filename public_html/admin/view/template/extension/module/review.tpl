        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-menu_editor" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="review_status" id="input-status" class="form-control">
                                ...
                                <option value="1" selected="selected"><?php echo $text_status; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_status; ?></option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-count">
                            <?php echo $entry_count; ?>
                        </label>
                        <div class="col-sm-10">
                            <input name="review_count" id="input-count" value="<?=$review_count?>"/>
                        </div>
                        
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-visible">
                            <?php echo $entry_visible; ?>
                        </label>
                        <div class="col-sm-10">
                            <input name="review_visible" id="input-visible" value="<?=$review_visible?>"/>
                        </div>
                    </div>
                </form>
            </div>
