...
<!---->          
          <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yandex_market_deliverycost"><span data-toggle="tooltip" title="<?php echo $help_deliverycost; ?>"><?php echo $entry_deliverycost; ?></span></label>
                <div class="col-sm-10">
				  <input type="text" name="yandex_market_deliverycost" value="<?php echo $yandex_market_deliverycost; ?>" placeholder="<?php echo $entry_deliverycost; ?>" id="input-yandex_market_deliverycost" class="form-control" />
                </div>
          </div>

          <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yandex_market_deliverydate"><span data-toggle="tooltip" title="<?php echo $help_deliverydate; ?>"><?php echo $entry_deliverydate; ?></span></label>
                <div class="col-sm-10">
				  <input type="text" name="yandex_market_deliverydate" value="<?php echo $yandex_market_deliverydate; ?>" placeholder="<?php echo $entry_deliverydate; ?>" id="input-yandex_market_deliverydate" class="form-control" />
                </div>
          </div>

          <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yandex_market_deliverypre"><span data-toggle="tooltip" title="<?php echo $help_deliverypre; ?>"><?php echo $entry_deliverypre; ?></span></label>
                <div class="col-sm-10">
				  <input type="text" name="yandex_market_deliverypre" value="<?php echo $yandex_market_deliverypre; ?>" placeholder="<?php echo $entry_deliverypre; ?>" id="input-yandex_market_deliverypre" class="form-control" />
                </div>
          </div>
<!---->
          <div class="form-group">
