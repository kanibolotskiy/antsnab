          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-email_opt"><?php echo $entry_email_opt; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_email_opt" value="<?php echo $config_email_opt; ?>" placeholder="<?php echo $entry_email_opt; ?>" id="input-email_opt" class="form-control" />
                  </div>
                </div>
