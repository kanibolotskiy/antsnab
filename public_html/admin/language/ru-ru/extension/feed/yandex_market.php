...
//Доставка
$_['entry_deliverycost']      = 'Стоимость доставки:';
$_['entry_deliverydate']      = 'Сроки доставки:';
$_['entry_deliverypre']       = 'Время, до которого нужно сделать заказ, чтобы получить его в этот срок:';
