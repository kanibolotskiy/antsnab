<?php
// HTTP
define('HTTP_SERVER', 'http://ant-snab/');

// HTTPS
define('HTTPS_SERVER', 'https://ant-snab/');

// DIR
define('DIR_APPLICATION', '/srv/http/ant-snab/public_html/catalog/');
define('DIR_SYSTEM', '/srv/http/ant-snab/public_html/system/');
define('DIR_IMAGE', '/srv/http/ant-snab/public_html/image/');
define('DIR_LANGUAGE', '/srv/http/ant-snab/public_html/catalog/language/');
define('DIR_TEMPLATE', '/srv/http/ant-snab/public_html/catalog/view/theme/');
